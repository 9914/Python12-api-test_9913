...
# @File     : A_06_Withdarw_test_case_02.py
# @Software : PyCharm
# @Explain  : 提现测试用例
...
#提现
excel_date_withdarw = excel_date.get_case('withdarw2')
...
#class HttpCase(unittest.TestCase):
    ...
    def test_http_case(self,i):
        ...
        try:
            ...
            if json.loads(res.get_text())['code'] == '10001':  # 提现成功，进行数据库校验
                ...
                if self.Pay_record is None:
                    ...
                    if self.Pay_record['Id'] == new_recod['Id']:
                        ...
                        my_log.info('数据库校验-->提现操作成功，流水记录ID是{}'.format(new_recod['Id']))
                    else:
            ...
            excel_date.write_by_case_id(sheet_name='withdarw2', case_id=i.case_id,
